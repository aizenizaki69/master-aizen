#!/bin/bash
# AizenLuis - V2Ray Premium Script
# © Github.com/master-aizen
# Official Repository: https://github.com/master-aizen/
# For Updates, Suggestions, and Bug Reports, Join to my Messenger Groupchat(VPS Owner) https://m.me/Aizenny24
# For Donations, Im accepting prepaid loads or GCash transactions:
# Smart: 09107203728
# Facebook: https://fb.me/Aizenny24
...
function InstAsk(){
 ...
 echo "###############################################################"
 echo "#                         V2RAY Script                        #"
 echo "#                        By: AizenLuis-V2Ray                       #"
 echo "#                     [GCASH] 09068462235                     #"
 echo "###############################################################"
 echo ""
 ...
 read -p "Domain Link: " -e -i www.aizenvpn.com MyDomain
...
if test $pwd == "@AizenLuis2021"; then
...
sleep 2
wget https://raw.githubusercontent.com/johndesu090/fhs-install-v2ray/master/install-xray.sh && chmod +x install-xray.sh && ./install-xray.sh
else
...
echo 'echo -e ""' >> .bashrc
echo 'echo -e ""' >> .bashrc
echo 'cowsay -f dragon "WELCOME MASTER." | lolcat' >> .bashrc
echo 'figlet -k AIZENLUIS' >> .bashrc
echo 'echo -e ""' >> .bashrc
echo 'echo -e "     =========================================================" | lolcat' >> .bashrc
echo 'echo -e "     *              WELCOME TO V2RAY | XRAY SERVER           *" | lolcat' >> .bashrc
echo 'echo -e "     =========================================================" | lolcat' >> .bashrc
echo 'echo -e "     *                 Autoscript By AizenLuis😈              *" | lolcat' >> .bashrc
echo 'echo -e "     *                  Debian 9, 10 & Ubuntu18              *" | lolcat' >> .bashrc
echo 'echo -e "     *                   Facebook: Aizenny24               *" | lolcat' >> .bashrc
echo 'echo -e "     =========================================================" | lolcat' >> .bashrc
echo 'echo -e "     *             For Donations [GCASH] 09068462235         *"' >> .bashrc
echo 'echo -e "     =========================================================" | lolcat' >> .bashrc
...
function InstWebsocket(){
 ...
 curl -kL "https://raw.githubusercontent.com/johndesu090/fhs-install-v2ray/master/config.json" -o /usr/local/etc/v2ray/config.json
 curl -kL "https://raw.githubusercontent.com/johndesu090/fhs-install-v2ray/master/v2ray.conf" -o /etc/nginx/conf.d/v2ray.conf
 ...
 wget -O /usr/local/sbin/xmenu https://raw.githubusercontent.com/johndesu090/fhs-install-v2ray/master/dev/xmenu
 wget -O /usr/local/sbin/vmenu https://raw.githubusercontent.com/johndesu090/fhs-install-v2ray/master/dev/vmenu
...
installnow() {
  ...
  if [[ "$V2RAY_RUNNING" -eq '1' ]]; then
	...
	echo 'WAIT UNTIL AIZEN SCRIPT FINISHED'
  fi
}
...
function ScriptMessage(){
 ...
 echo -e ""
 echo -e " https://fb.com/Aizenny24"
 echo -e "[GCASH] 09068462235 "
 echo -e ""
}
...
echo "*                                 -AizenLuis-V2RAY-                                 *"
echo "--------------------------------------------------------------------------------"
echo "-----------------------"  | tee -a log-install.txt
echo "Premium Script Information"  | tee -a log-install.txt
echo "-----------------------"  | tee -a log-install.txt
echo "DONATION:"  | tee -a log-install.txt
echo "GCASH: 09068462235"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "Developed:"  | tee -a log-install.txt
echo "©AizenSarmiento"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
